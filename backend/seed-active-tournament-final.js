...
async function main() {
  ...
  // 8. Create matches for Group 1 (round-robin: 6 matches)
  const group1Matches = [
    [0, 1], [0, 2], [0, 3],
    [1, 2], [1, 3],
    [2, 3]
  ...
  // 9. Create matches for Group 2 (round-robin: 6 matches)
  const group2Matches = [
    [4, 5], [4, 6], [4, 7],
    [5, 6], [5, 7],
    [6, 7]
